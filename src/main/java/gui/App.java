...
public class App
{
    ...
    private void createUIComponents()
    {
        ...
        priceHistory = new ChartPanel(chart, true, true, true, false, true);
        pricePrediction = new ChartPanel(chart, true, true, true, false, true);
    }

    /**
     * Method executed by Intellij IDEA when creating UI.
     */
